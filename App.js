...
import { Container, View, Left, Right, Button, Icon, Item, Input , Text , Colors , color } from 'native-base';
      ...
      <Container style={{backgroundColor: '#fdfdfd'}}>
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', paddingLeft: 50, paddingRight: 50}}>
          <View style={{marginBottom: 35, width: '100%'}}>
            <Text style={{fontSize: 24, fontWeight: 'bold', textAlign: 'left', width: '100%', color: '#ff0000'}}>Welcome back, </Text>
          ...
          <View style={{alignItems: 'center'}}>
            <Button onPress={() => this.login()} style={{backgroundColor: '#ff0000', marginTop: 20}}>
